...
//
// Render fixture: 1x2 carabiner clip on the 52x6.5 preset.
...
carabiner_clip(kanix_preset_52x65,
    ...
    hole_cols           = 2,    // columns along the plate's long edge
    outer_disc_diameter = 21,   // outside diameter of the carabiner disc
    outer_disc_height   = 52/3/3,   // disc thickness (axis = Y, away from plate)
    inner_disc_diameter = 15,   // through-hole the carabiner clips into
    ...
    disc_z_override     = 12 // disc bottom flush with plate bottom (Z=0)
);
