...
carabiner_clip(kanix_preset_52x65,
    ...
    outer_disc_diameter = 32,   // outside diameter of the carabiner disc
    outer_disc_height   = 52/3/3,   // disc thickness (axis = Y, away from plate)
    inner_disc_diameter = 25,   // through-hole the carabiner clips into
    ...
    disc_z_override     = 20 // disc bottom flush with plate bottom (Z=0)
);
