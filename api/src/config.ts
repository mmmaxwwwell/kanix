...
export interface Config {
  ...
  readonly EASYPOST_WEBHOOK_SECRET: string;
...
export function loadConfig(options: LoadConfigOptions = {}): Config {
  ...
  return {
    ...
    PUBLIC_STRIPE_PUBLISHABLE_KEY: get("PUBLIC_STRIPE_PUBLISHABLE_KEY"),
    ...
    EASYPOST_WEBHOOK_SECRET: get("EASYPOST_WEBHOOK_SECRET"),
